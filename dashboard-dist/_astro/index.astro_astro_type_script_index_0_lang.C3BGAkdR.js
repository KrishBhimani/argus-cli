import{a as $}from"./api.B63xdRaj.js";import{s as k,e as _,b as y,d as L,n as v,t as w,u as C}from"./format.BCwVRjzP.js";let l=[],c="started_at",a=!0;const u=e=>document.querySelector(e),p=u("#t tbody"),f=u("#search"),E=u("#count");function h(e){return e.total_fresh_input_tokens+e.total_output_tokens+e.total_cache_read_tokens+e.total_cache_write_tokens}function i(){const e=f.value.toLowerCase();let o=l.filter(t=>!e||t.id.toLowerCase().includes(e)||t.project_path.toLowerCase().includes(e)||t.primary_model.toLowerCase().includes(e));const s=(t,n)=>n==="tokens"?h(t):t[n];o.sort((t,n)=>{const r=s(t,c),d=s(n,c),m=r==null?-1:d==null?1:r<d?-1:r>d?1:0;return a?-m:m}),E.textContent=`${o.length} of ${l.length} sessions`,p.innerHTML=o.map(t=>`
